// EDUCATION entries, newest first — matches the original PDF's order.

#import "style.typ": heading2, edu

#let heading = heading2[EDUCATION]

#let udemy = edu("Since 2024", "Udemy Instructor", "Tekton - The quick start")[
...
#let bsc = edu("2016 - 2020", "B. Sc. - IT-Security", "University of Darmstadt")[
...
#let technician = edu("2014 - 2016", "State certified technician", "Technical College Braunschweig")[
...
#let it-specialist = edu("2010 - 2013", "IT specialist - system integration", "Company GEKA mbh")[
